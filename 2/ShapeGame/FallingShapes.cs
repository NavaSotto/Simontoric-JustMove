...
namespace ShapeGame.Utils
{
    ...
    {
        None = 0x00,//$$ אף פגיעה
        Hand = 0x01,//$$ פגיעה מסוג יד-נגיעה קלה עם היד
        Arm = 0x02,//$$פגיעה מסוג זרוע
        Squeezed = 0x04,//$$פגיעה מסוג מעיכת ה"סינג
        Popped = 0x08//$$פגיעה מסוג הקפצת הסינג
    }
    ...
    public struct BoneData
    {
        ...
        //@@$$$$$$$$$$$$4
         //@@public System.Windows.Media.Brush jointB;//@@
         //@@public System.Windows.Media.Brush boneB;//@@
        //@@$$$$$$$$$$$$$$$$$$$$$44
        ...
        public BoneData(Segment s)
        {
           ...
           //@@ jointB = new SolidColorBrush(System.Windows.Media.Color.FromRgb(0, 0, 0)); //צהוב //@@
           //@@ boneB = new SolidColorBrush(System.Windows.Media.Color.FromRgb(0, 0, 0));     //$$ירוק //@@
