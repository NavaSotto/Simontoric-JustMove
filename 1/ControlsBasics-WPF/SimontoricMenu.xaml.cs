...
namespace Microsoft.Samples.Kinect.ControlsBasics
{
    ...
    /// </summary>
    public partial class SimontoricMenu
    {
        ...
        private void KinectTileButton_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            this.sensorChooser.Stop();
            SimontoricMainWindow w = new SimontoricMainWindow();
            backgroundWindow.ImageSource = new BitmapImage(new Uri(@"C:\Users\nava\source\repos\כל גרסאות הפרויקטים-במחשב\גיבוי אחרון\Images\simontoricScreen1.jpg"));
        ...
        private void KinectTileButton_Click_2(object sender, RoutedEventArgs e)
        {
            ...
            SimontoricMainWindow w = new SimontoricMainWindow();
            w.TypeOfGame = "בינוני";
            backgroundWindow.ImageSource = new BitmapImage(new Uri(@"C:\Users\nava\source\repos\כל גרסאות הפרויקטים-במחשב\גיבוי אחרון\Images\simontoricScreen2.jpg"));
        ...
        private void KinectTileButton_Click_3(object sender, RoutedEventArgs e)
        {
            ...
            this.sensorChooser.Stop();
            SimontoricMainWindow w = new SimontoricMainWindow();
            backgroundWindow.ImageSource = new BitmapImage(new Uri(@"C:\Users\nava\source\repos\כל גרסאות הפרויקטים-במחשב\גיבוי אחרון\Images\simontoricScreen3.jpg"));
            w.TypeOfGame = "קל";
        ...
        private void InstructionsClick(object sender, RoutedEventArgs e)
        {
            ...
            //כדי שהמצלמה תעבוד במסך החדש שנפתח נעצור את הסנסור הנוכחי של המצלמה
            this.sensorChooser.Stop();
            SimontoricInstructions w = new SimontoricInstructions();
            w.Show();
            Close();
        }
